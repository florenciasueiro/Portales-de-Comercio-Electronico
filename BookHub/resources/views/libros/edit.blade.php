...
<section class="min-h-screen bg-gradient-to-b from-neutral-900 to-black text-gray-100 py-12 px-6">
  <div class="max-w-3xl mx-auto bg-neutral-800/80 p-8 rounded-2xl shadow-lg border border-red-600/30">
    ...
    <h1 class="text-3xl font-bold mb-8 text-center text-red-400 drop-shadow-md">✏️ Editar Libro</h1>
    ...
    <form action="{{ route('libros.update', $libro) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
      @csrf
      @method('PUT')
      ...
      <div>
        ...
        <input type="text" name="titulo" value="{{ old('titulo', $libro->titulo) }}"
               class="w-full p-3 bg-neutral-900 border border-neutral-700 rounded-lg focus:border-red-500 focus:ring-1 focus:ring-red-500 transition" required>
      </div>
      ...
      <div>
        ...
        <input type="text" name="categoria" value="{{ old('categoria', $libro->categoria) }}"
      ...
      <div>
        ...
        <div class="flex gap-2">
          <input id="imagen-url" type="text" name="imagen" value="{{ old('imagen', $libro->imagen) }}" placeholder="Opcional si subes archivo"
      ...
      <div>
        ...
        <textarea name="descripcion" rows="4"
                  class="w-full p-3 bg-neutral-900 border border-neutral-700 rounded-lg focus:border-red-500 focus:ring-1 focus:ring-red-500 transition">{{ old('descripcion', $libro->descripcion) }}</textarea>
      </div>
